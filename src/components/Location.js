    ...
    return (
        ...
        <div>
             ...
             <div className="location-container" >
                 ...
                 <div className="location" style={{backgroundImage: `url(${project.secondImage.asset.url})`}} >                    
                        

                    <div  className="landing-page-header">
                                <h3>{project.name}</h3>
                                <BlockContent blocks={project.description} projectId="" dataset="production" className="block-content"/>
                    </div>
                    <div className="landing-page-header">
